...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (true) {
            ...
            reiziger = new Reiziger(6, "Job", "Stoker",
        ...
        if (true) {
            ...
            if (reiziger == null) {
                ConsoleColor.log("Reiziger is verwijderd", ConsoleColor.ANSI_CYAN);
            } else {
                ConsoleColor.log("Reiziger is niet verwijderd", ConsoleColor.ANSI_CYAN);
            }
        }
